...
from Config.Config import parallel_pattern_ntoken, d_model, nheads, nlayer, d_hid, dropout, PATH, text_condition_max_length, melody_condition_max_length
...
with torch.no_grad():
    ...
    compressor.decompress(output, "Dataset\\InferenceData\\ParallelOutput.wav")
