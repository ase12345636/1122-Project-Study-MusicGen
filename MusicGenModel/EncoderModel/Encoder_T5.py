...
class Encoder_T5(nn.Module):
    ...
    def forward(self, mem_input: list[str], only_token_ids=False):
        '''
    ...
    ->  Output : mem_input
        ...
        if only_token_ids == False:
            ...
            # Permute condition ids and return
            return torch.reshape(text_condition_ids, (1, -1, self.max_length))
